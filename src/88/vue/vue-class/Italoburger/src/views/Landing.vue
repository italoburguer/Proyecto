<template>
  <div>
    ...
    <header id="home" class="header">
      <div
        class="main_menu_bg navbar-fixed-top wow slideInDown"
      ...
      <div class="container">
        <div class="row">
          <div class="features_content text-center">
            ...
            <div class="col-md-4">
              <div
                class="sinle_features wow slideInUp"
    ...
    <section id="special" class="special sections">
      <div class="container">
        <div class="row">
          <div
            class="head_title text-center wow slideInLeft"
            data-wow-duration="1.5s"
          >
          ...
          <div
            class="main_special text-center wow slideInUp"
      ...
      <div class="container">
        <div class="row">
          <div class="main_abouts">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div
                class="single_abouts wow slideInRight"
                data-wow-duration="2s"
              >
                <img src="@/assets/images/abimg.png" alt="" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="main_menus">
            <div
              class="head_title text-center wow slideInDown"
              data-wow-duration="2s"
            >
              <h2>Menu</h2>
              <div class="separetor"></div>
            ...
            <div
              class="menus_top_menu text-center wow slideInDown"
              data-wow-duration="1.5s"
            >
              <ul>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div
                class="single_menus wow slideInLeft"
                data-wow-duration="1.5s"
              >
                <ul>
                  <li>
                    ...
                    ...........................................................
                    12$ <span> ricotta, shallots, cheddar, capers</span>
                  </li>
                  <li>
                    SMOKED RICOTTA TERRINE
                    ...........................................................
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div
                class="single_menus wow slideInRight"
                data-wow-duration="1.5s"
              >
                <ul>
                  <li>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="copyright_text_area">
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div
                class="single_footer text-right wow zoomIn"
                data-wow-duration="2s"
              >
                <p>
...
<style scoped>
.loaded{
     background-image: url(../assets/images/preloading.gif);
}
.separetor{
	background:url(../assets/images/spr.png) no-repeat center center;
...
.banner .scroll_btn:hover {
	background: url(../assets/images/scroll.gif) 50% 50% no-repeat #f3c30f;
}
.banner{
...
.footer{
	background:url(../assets/images/footerbg.jpg) no-repeat center top;
